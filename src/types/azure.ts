...
export type PlaygroundMode = 'text-to-speech' | 'speech-to-text' | 'voice-changer' | 'multi-talker' | 'voice-creation' | 'video-translation' | 'voice-live-chat' | 'voice-live-translator' | 'voice-live-calculator' | 'podcast-agent' | 'gemini-live';
